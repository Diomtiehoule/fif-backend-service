...
import {createDefaultRole , createDefaultType , createDefaultCategorie} from "./utils/role";
...
import { votantRouter } from "./controllers/votant.controller";
...
const server = app.listen(PORT , async() =>{
    try{
        ...
        db.$connect().then(async () => {
            ...
            await Promise.all([createDefaultRole(), createDefaultAdmin() , createDefaultType() , createDefaultCategorie()]);
          });
